import java.util.Scanner;
  ...
  public static void main(String[] args) {
    ...
    if(iniciar == 1){
      ...
      if(continuar == 1){
        System.out.println("Enquanto estava em combate, um aldeão que estava fugindo dos ataques com seu bebê, acaba entrando no meio do combate, onde encontra Diana.\nO que Diana deve fazer?");
        System.out.println("1. Proteger o aldeão. \n2. Continuar lutando");
        int escolha1 = input.nextInt();
        if(escolha1 == 1){
          System.out.println("Diana pede para que o aldeão fuja, pois ela conterá os Darkins. Ao começar a correr, arqueiros Darkins aparecem e começam a atirar em direção a Diana e o aldeão que acabou sendo atingido e morrendo enquanto estava correndo.");
        }else if(escolha1 == 2){
          System.out.println("Diana com o sangue fervendo dá batalha ignora o aldeão e continua lutando. Nisso o aldeão é atingido e o bebê fica vulnerável no meio do combate");
        
        }
        System.out.println("Escolha a próxima ação. \n1. Ir em direção ao bebê. \n2. Sacrificar o bebê.");
        int escolha2 = input.nextInt();
        if(escolha2 == 1){
          System.out.println(" Nisso Diana vê e vai em direção ao bebê para protegê-lo, mas um guerreiro Darkin que estava caído a atacou e a derrubou. Diana se levanta e com muita ira ataca o guerreiro Darkin. O ataque foi tão forte que toda a água congelada começou a se quebrar.");
        }else if(escolha2 == 2){
        ...
        if(escolha3 == 1){
          ...
          if(escolha4 == 1){
            System.out.println("Braum ao perceber a avalanche, larga seu escudo e tenta correr o mais rápido possível para encontrar algo que poderia proteger ele e a criança, contudo não conseguiu e todos foram levados pela avalanche. \n\n\n FIM.");
            System.out.println("\n\nObrigado por participar do nosso livro interativo.");
          }else if(escolha4 == 2){
            System.out.println("Braum pega seu escudo e com toda sua força tenta proteger ele e a criança da avalanche, mas por precisar utilizar as duas mãos para segurar a enorme avalanche, acaba soltando a criança e apenas ele sobreviveu. \n\n\n FIM.");
            System.out.println("\n\nObrigado por participar do nosso livro interativo.");
          }else if(escolha4 == 3){
        ...
        System.out.println("Por hoje é isso. Volte sempre");
      }
    }else{
      System.out.println("Por hoje é isso. Volte sempre.");
    }
